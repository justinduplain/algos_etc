...
A format for expressing an ordered array of integers is to use a comma separated array of either
...
const solution = array => {
  console.log(array)
  //x points to the low/left value in a range
  ...
  while (b < array.length) {
    ...
    if (x === a) {
      ...
      if (array[b] - array[a] === 1) {
        ...
        // a range. if the right value is again
        if (array[b] - array[a] === 1)
      }
    }
    // we've stepped in to evaluating range now as x is not equal to a
    if
